...
exports.run = async (client, message, args) => {
  ...
  var m = await message.channel.send(`${client.emojis.get("487315220323237908")} Gerekli veriler hesaplanıyor...`)
...
.addField('Diğer Bilgiler', `İnternet Portunun IP'sı: **Gizli**
